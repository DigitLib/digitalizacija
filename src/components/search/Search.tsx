  ...
  return (
    <div className="self-center">
      <button onClick={() => setSearch(true)} aria-label="Search">
        <i
          className="fa fa-search self-center hover:text-accent dark:hover:text-white text-2xl"
      ...
      >
        <div className="relative">
          <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
            <i className="fa fa-search text-white-400 dark:text-white-300"></i>
          </div>
          <input
            type="search"
            id="default-search"
            ...
            placeholder="Претрага (користите '&uarr;' и '&darr;' за навигавију, 'Esc' да затворите, 'Enter' да отворите)"
            autoFocus
